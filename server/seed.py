...
print('Starting to seed all products...')
...
Key specs: 162g weight, 7.5mm thickness, IP65 dust/water resistance, Nano-SIM support.''',
        ...
        'price': Decimal('51999.00'),  # ~$400 USD
        'stock_quantity': 15,
        'in_stock': True,
...
Expected release: July 2025. Dimensions: 161.2 x 74.7 x 7.8 mm, Weight: 185g.''',
        'category': categories['Smartphones'],
        'price': Decimal('38870.00'),  # ~$299 USD
        'stock_quantity': 8,
        'in_stock': True,
...
Build: Glass front (Gorilla Glass 7), plastic frame, plastic back. Weight: 179g.''',
        'category': categories['Smartphones'],
        'price': Decimal('53170.00'),  # ~$409 USD
        'stock_quantity': 12,
        'in_stock': True,
...
Features water-repellent design and stereo speakers for enhanced multimedia experience.''',
        'category': categories['Smartphones'],
        'price': Decimal('25999.00'),  # ~$200 USD
        'stock_quantity': 25,
        'in_stock': True,
...
for product_data in products_data:
    ...
    if created:
        ...
        print(f'✓ Created: {product.name} - KES {product.price} ({category_name})')
    else:
        ...
        product.save()
        updated_count += 1
        print(f'✓ Updated: {product.name} - KES {product.price} ({category_name})')
